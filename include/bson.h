...
/**
 * Get the value size of the BSON object currently pointed to by the iterator.
 *
 * @param i the bson_iterator
 *
 * @return  the value size of the current BSON object.
 */
...
/**
 * Append bson value to a bson.
 *
 * @param b the bson to append to.
 * @param name the key for the bson data.
 * @param type the type for the value.
 * @param buffer the value for the bson data.
